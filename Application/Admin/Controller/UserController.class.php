...
class UserController extends AdminController
{
    ...
    protected function _initialize()
    {
        ...
        $this->assign('uid',$uid);
        switch(ACTION_NAME){
            case 'expandinfo_details':
                $profile_group_id = WEIYUAN;
                break;
            case 'dcs_details':
                $profile_group_id = DCS;
                break;
            case 'msz_details':
                $profile_group_id = MSZ;
                break;
            case 'team_details':
                $profile_group_id = TEAM;
                break;
            case 'unit_details':
                $profile_group_id = UNIT;
                break;
            case 'zwhxx_details':
                $profile_group_id = ZWHXX;
                break;
            case 'zxgzry':
                $profile_group_id = ZXGZRY;
                break;
        }
