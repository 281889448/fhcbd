...
CREATE TABLE IF NOT EXISTS `thinkox_advertising` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE IF NOT EXISTS `thinkox_advs` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `thinkox_channel` (`id`, `pid`, `title`, `url`, `sort`, `create_time`, `update_time`, `status`, `target`, `color`, `band_color`, `band_text`) VALUES
...
(10, 'WEB_SITE_ICP', 1, '网站备编号', 1, '', '设置在网站底部显示的备编号，如“沪ICP备12007941号-2', 1378900335, 1379235859, 1, '浙ICP备XX号', 12),
...
(38, 'WEB_SITE', 1, '网站名称', 1, '', '用于邮件,短信,站内信显示', 1388332311, 1388501500, 1, 'ThinkOX', 3),
...
CREATE TABLE IF NOT EXISTS `thinkox_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `title` text NOT NULL,
  `create_time` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `thinkox_group_bookmark` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `post_id` int(11) NOT NULL,
  `create_time` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `thinkox_group_dynamic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `thinkox_group_lzl_reply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `post_id` int(11) NOT NULL,
  `to_f_reply_id` int(11) NOT NULL,
  `to_reply_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `thinkox_group_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `group_id` int(11) NOT NULL,
  `uid` int(11) NOT NULL,
  `status` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `thinkox_group_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `group_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `thinkox_group_post` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `group_id` int(11) NOT NULL,
  `title` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `thinkox_group_post_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `thinkox_group_post_reply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `post_id` int(11) NOT NULL,
  `parse` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `thinkox_group_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `thinkox_group_type` (`id`, `title`, `status`, `sort`, `create_time`) VALUES
(1, '群组默认分类', 1, 0, 1409811696);
...
CREATE TABLE IF NOT EXISTS `thinkox_menu` (
  ...
  PRIMARY KEY (`id`),
  KEY `pid` (`pid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2235 ;
...
(219, '论坛设置', 122, 10, 'Forum/config', 0, '', '设置', 0),
(220, '专辑设置', 154, 0, 'Issue/config', 0, '', '设置', 0),
(221, '活动设置', 188, 0, 'Event/config', 0, '', '设置', 0),
(222, '等级管理', 16, 0, 'User/level', 0, '', '用户管理', 0),
...
CREATE TABLE IF NOT EXISTS `thinkox_message` (
  ...
  `status` tinyint(4) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='thinkox新增消息表' AUTO_INCREMENT=322 ;
...
CREATE TABLE IF NOT EXISTS `thinkox_super_links` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `thinkox_super_links` (`id`, `type`, `title`, `cover_id`, `link`, `level`, `status`, `create_time`) VALUES
...
ALTER TABLE  `thinkox_shop` CHANGE  `goods_detail`  `goods_detail` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT  '商品详情';

ALTER TABLE  `thinkox_file` ADD  `driver` VARCHAR( 50 ) NOT NULL;
ALTER TABLE  `thinkox_advertising` ADD  `s` TINYINT NOT NULL;
