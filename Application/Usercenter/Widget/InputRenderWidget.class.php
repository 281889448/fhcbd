        ...
        switch($data['form_type']){
            ...
            case 'time':
                ...
                if(!$data['field_content']){
                    ...
                    $data['field_content']['field_data']= $data['field_content']['field_data'] ? date("Y-m-d",$data['field_content']['field_data']) : '';
                    $this->assign('field_data',$data['field_content']['field_data']);
                }
	        ...
	        case 'picture':
		        ...
		        $this->display('Widget/picture_template');
		        break;
	        case 'file':
		        $this->assign('field_name',$data['field_name']);
		        $validation=$this->_getValidation($data['validation']);
		        ...
		        $this->display('Widget/file_template');
	        	break;
